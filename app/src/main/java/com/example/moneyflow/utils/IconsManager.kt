...
object IconsManager {
    fun getAllCategoryExpenseIcons(): List<Category> {
        return listOf<Category>(
            ...
            Category(name = "", icon = "ic_home", isIncome = false),
            Category(name = "", icon = "ic_cafe", isIncome = false),
            Category(name = "", icon = "ic_education", isIncome = false),
            Category(name = "", icon = "ic_gift", isIncome = false),
            Category(name = "", icon = "ic_grocery", isIncome = false)
        )
    }
}