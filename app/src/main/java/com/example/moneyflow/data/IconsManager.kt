...
object IconsManager {
    fun getAllCategoryExpenseIcons(): List<Category> {
        return listOf<Category>(
            ...
            Category(name = "", iconResId = R.drawable.ic_health, isIncome = false),
            Category(name = "", iconResId = R.drawable.ic_leisure, isIncome = false),
            Category(name = "", iconResId = R.drawable.ic_home, isIncome = false),
            Category(name = "", iconResId = R.drawable.ic_cafe, isIncome = false),
            Category(name = "", iconResId = R.drawable.ic_education, isIncome = false),
            Category(name = "", iconResId = R.drawable.ic_gift, isIncome = false),
            Category(name = "", iconResId = R.drawable.ic_grocery, isIncome = false)
        )
    }
}